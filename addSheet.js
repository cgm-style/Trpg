function addSheet(num,leadLoadGameSet) {
    let myStr = leadLoadGameSet[num].str,   // 힘
        ...
        MyCP = leadLoadGameSet[num].CP, // 동화
        MySP = leadLoadGameSet[num].SP, // 은화
        MyEP = leadLoadGameSet[num].EP, // 호박금화
        MyGP = leadLoadGameSet[num].GP, // 금화
        MyPP = leadLoadGameSet[num].PP, // 백금화
